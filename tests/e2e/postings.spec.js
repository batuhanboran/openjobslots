...
async function expectSearchEngineVisualContract(page) {
  ...
  if (viewport.width >= 768) {
    ...
    await expect(page.getByText("Public v1.5.4")).toBeVisible();
    ...
    await expect(page.getByText("Version 1.5.4")).toBeVisible();
    await expect(page.getByText("Search index and sync freshness repair")).toBeVisible();
    ...
    await expect(page.getByText("Public v1.5.4")).toHaveCount(0);
