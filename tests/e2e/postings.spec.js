...
async function expectSearchEngineVisualContract(page) {
  ...
  if (viewport.width >= 768) {
    ...
    await expect(page.getByText("Public v1.6.0")).toBeVisible();
    ...
    await expect(page.getByText("Production hardening release")).toBeVisible();
    ...
    await expect(page.getByText("Public v1.6.0")).toHaveCount(0);
