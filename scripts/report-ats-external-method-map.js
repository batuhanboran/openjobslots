...
const TARGETS = [
  {
    ...
    current_gap: "Repo certification now has an RSS pilot path plus existing HTML fallback fixtures.",
    recommended_action: "Use Teamtailor RSS as the preferred method and keep HTML fixture parsing as a fallback guard.",
  ...
  {
    ats_key: "personio",
    target_type: "configured-disabled-source-hardening",
    internal_source_module: "server/ingestion/sources/personio",
    external_refs: ["kalil0321/ats-scrapers:personio.py", "Personio XML feed"],
    current_gap: "Configured source module exists, but it remains disabled until live inventory, bounded canary, field-quality, and search parity evidence are proven.",
    recommended_action: "Use the Personio XML method only for fixture-backed canary hardening before public writes are considered.",
  ...
  },
  {
    ats_key: "workable",
    target_type: "configured-disabled-source-hardening",
    internal_source_module: "server/ingestion/sources/workable",
    external_refs: ["kalil0321/ats-scrapers:workable.py"],
    current_gap: "Configured source module exists, but it remains disabled until live inventory, bounded canary, field-quality, and search parity evidence are proven.",
    recommended_action: "Use the public account API method only for fixture-backed canary hardening; keep private token routes out until separately reviewed.",
    phases: ["phase_1", "phase_3"],
    priority: 6
  },
  {
