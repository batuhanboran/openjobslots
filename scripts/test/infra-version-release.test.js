...
assert.match(app, /version: "3\.0\.2",\s*date: "August 24, 2026"/);
assert.match(app, /"3\.0\.2": \{\s*title: "Güvenli remote kaynak canary'leri ve kararlı deploy"/);
assert.match(webSite, /APP_VERSION = "3\.0\.2"/);
assert.match(webNotes, /version: "3\.0\.2",\s*date: "24 Ağu 2026"/);
assert.match(webDeploy, /openjobslots-web:3\.0\.2/g);
