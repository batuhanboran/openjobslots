...
assertContains(workerBlock, "OPENJOBSLOTS_POSTING_FRESHNESS_WRITE_INTERVAL_SECONDS=${OPENJOBSLOTS_POSTING_FRESHNESS_WRITE_INTERVAL_SECONDS:-21600}");
assertContains(workerBlock, "OPENJOBSLOTS_RETENTION_INTERVAL_MS=${OPENJOBSLOTS_RETENTION_INTERVAL_MS:-21600000}");
assertContains(workerBlock, "OPENJOBSLOTS_SOURCE_QUALITY_PROTECTION_INTERVAL_MS=${OPENJOBSLOTS_SOURCE_QUALITY_PROTECTION_INTERVAL_MS:-21600000}");
assertContains(workerBlock, "OPENJOBSLOTS_PUBLIC_STATS_REFRESH_INTERVAL_MS=${OPENJOBSLOTS_PUBLIC_STATS_REFRESH_INTERVAL_MS:-21600000}");
