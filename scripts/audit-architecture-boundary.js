...
const SOURCE_COMMON_SOURCE_LOCAL_OWNERSHIP_PATTERNS = Object.freeze([
  ...
  { name: "lever_parser_import", regex: /require\(["']\.\/lever\/parse["']\)/ },
  { name: "lever_parser_spec", regex: /lever:\s*{[\s\S]*?parser:\s*parseLeverPostingsFromApi/ },
  ...
  { name: "saphrcloud_parser_import", regex: /require\(["']\.\/saphrcloud\/parse["']\)/ },
  { name: "saphrcloud_parser_spec", regex: /saphrcloud:\s*{[\s\S]*?parser:\s*parseSapHrCloudPostingsFromApi/ },
  { name: "ultipro_parser_import", regex: /require\(["']\.\/ultipro\/parse["']\)/ },
  { name: "ultipro_parser_spec", regex: /ultipro:\s*{[\s\S]*?parser:\s*parseUltiProPostingsFromApi/ },
