...
Current live production data-quality finding: 722,591 active postings; 625,905 are missing `country`/`region`; 96,686 have `country`/`region`. The biggest ATS gaps include `icims`, `applitrack`, `applytojob`, `breezy`, `bamboohr`, and `ashby`.
