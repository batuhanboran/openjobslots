...
- Strict saved raw parser-fixture-backed ATS keys: 11 (`adp_workforcenow`, `applicantpro`, `applitrack`, `careerplug`, `fountain`, `icims`, `manatal`, `oracle`, `paylocity`, `pinpointhq`, `recruitcrm`).
...
- Configured ATS still pending strict raw parser fixtures: 48.
