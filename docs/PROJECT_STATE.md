...
- Public health: `331,766` visible job slots, `40,860` companies, `29,767` sync-enabled companies, `37` visible ATS, and `70,247` rows seen in 24h. Source state split is `13` full-enabled, `31` canary, `8` quarantine-only, `10` disabled, and `44` worker-auto-eligible ATS.
...
- Source freshness posture is `hold`, not scale-up: `30,833` due targets, `3,837` processed in 24h, `90.44%` target success, `12,054` new rows, `0` new public no-geo/no-remote rows, but `266` unresolved parser-attention events plus `266` parser-bug failures, `888` source-quality failures, `79` empty-no-jobs failures, `5` auth failures, `3` rate-limit failures, and `7` unknown failures.
