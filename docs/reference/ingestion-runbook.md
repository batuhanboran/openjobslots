...
npm.cmd run ats:source:canary -- --source=<ats> --limit=25 --confirm-production --backup-confirmed --worker-isolated --planned-batch=<report> --predicted-guard-result=pass --json
